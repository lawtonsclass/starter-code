...
// constructor
// FIXME: make the tree start out empty
BST::BST() {}
...
// FIXME: search for a node by key
...
// FIXME: return the predecessor of a given node
...
// FIXME: use the search and remove functions to delete a key if it exists
