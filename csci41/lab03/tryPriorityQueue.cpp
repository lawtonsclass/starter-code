...
int main() {
  ...
  // FIXME: create a priority queue that holds ints
  // FIXME: push {1, -2, 3, -4, ..., 49, -50} onto the priority queue,
  //        in that order
  // FIXME: in a loop, do the following while the priority queue isn't
  //        empty:
