...
int main() {
  ...
  // TODO: Follow any of the r0-r12 registers that look like address
  // values (i.e., they hold huge (positive or negative) numbers). Go
  // to those addresses and inspect the first 10 integer values in
  // memory there. Do you find anything interesting?
