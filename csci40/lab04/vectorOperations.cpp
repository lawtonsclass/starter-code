...
int main(int argc, char* argv[]) {
  ...
  // FIXME: read all of the command line arguments (not including the program
  ...
  // FIXME: find & print the second-smallest element (duplicates count as
  // separate elements!);
  // FIXME: find & print the second-largest element (duplicates count as
  // separate elements!)
